#!/usr/bin/env python3
# eeg_transformer.py - Transformer model with wavelet features for EEG classification
...
def preprocess_data(data, labels, wavelet_features, test_size=0.2, val_size=0.2):
    """Preprocess data for Transformer model with wavelet features"""
    print("\n🔄 Preprocessing data...")
    ...
    # For Transformer, we need shape [batch_size, sequence_length, features]
...
def train_model(model, train_loader, val_loader, num_epochs=50, weight_decay=1e-4):
    ...
    plt.tight_layout()
    plt.savefig('eeg_transformer_training_history.png')
    print("\n📊 Training history plot saved as 'eeg_transformer_training_history.png'")
...
def main():
    """Main function"""
    print("🚀 Transformer with Wavelet Features for EEG Classification")
    print("=" * 50)
    ...
    print("\n💾 Model saved as 'eeg_transformer_model.pth'")
