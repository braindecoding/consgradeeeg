...
def train_model(model, train_loader, val_loader, num_epochs=50, weight_decay=1e-4):
    ...
    plt.tight_layout()
    plt.savefig('results/figures/eeg_lstm_wavelet_training_history.png')
    print("\n📊 Training history plot saved as 'results/figures/eeg_lstm_wavelet_training_history.png'")
...
def main():
    ...
    # Load data (adjust path for new structure)
    ...
    # Save model (optional - models are large and gitignored)
    # torch.save(model.state_dict(), '../../models/eeg_lstm_wavelet_model.pth')
    # print("\n💾 Model saved as '../../models/eeg_lstm_wavelet_model.pth'")
    print("\n💾 Model weights not saved (large files, can be regenerated)")
